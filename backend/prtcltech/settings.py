"""
Django settings for prtcltech project.
"""
...
WSGI_APPLICATION = 'prtcltech.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('POSTGRES_DB', default='prtcltech'),
        'USER': config('POSTGRES_USER', default='prtcltech'),
        'PASSWORD': config('POSTGRES_PASSWORD', default='prtcltech'),
